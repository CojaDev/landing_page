    ...
    >
      <div className="flex h-full flex-col items-start justify-between p-6 lg:px-20 lg:py-10">
        ...
        <div className="flexCenter gap-6">
          ...
          <p className="bold-16 md:bold-18 text-white">{peopleJoined}</p>
        </div>
      </div>
    </div>
  );
...
const Camp = () => {
  return (
    <section className="2xl:max-container relative flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20">
      <div className="hide-scrollbar flex w-full items start-justify-start gap-8 h-[340px] overflow-x-auto lg:g-[400px] xl:h-[640px]">
        <CampSite
